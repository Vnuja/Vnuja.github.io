    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <a href="http://localhost/IWT/BestWeb/index.php"><span class="dashboard">BEST WEB</span></a>
            </div>
...
if (isset($_POST["submit"])) {
    ...
    if ($conn->query($sql) === TRUE) {
        $msg = "<div class='success'>User $action successfully</div>";
        echo "<script>setTimeout(() => { window.location.href='manage_users.php'; }, 500);</script>";
    } else {
        $msg = "<div class='alert'>User $action failed: " . $conn->error . '</div>';
    }
}
...
<form style="margin-top: 25px;" class="Add" action="" method="POST">
        ...
        <div class="preference">
            ...
            <input placeholder="Password" type="password" id="password" name="password" value="dummy_password">
        </div>
        <br><br>
        <div class="preference">
